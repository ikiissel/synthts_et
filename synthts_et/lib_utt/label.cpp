...
phrase_struct pause_struct() {
	...
	phone_struct phs;
	phs.syl_p = no_v; phs.word_p = no_v; phs.phr_p = no_v; phs.utt_p = no_v;
	phs.p6 = -1; phs.p7 = -1; 
	phs.a1 = 0; phs.a3 = 0; 
	phs.b1 = -1; phs.b3 = -1;
	phs.b4 = -1; phs.b5 = -1;
	phs.b6 = -1; phs.b7 = -1;
	phs.c1 = 0; phs.c3 = 0;
	phs.lpos = L"0"; phs.d2 = 0;		
	phs.pos = L"0"; phs.e2 = -1;		
	phs.e3 = -1; phs.e4 = -1;	
	phs.rpos = L"0"; phs.f2 = 0;
	phs.g1 = 0; phs.g2 = 0;
	phs.h1 = -1; phs.h2 = -1;
	phs.h3 = 1; phs.h4 = 1;
	phs.i1 = 0; phs.i2 = 0;		
	phs.j1 = 1; phs.j2 = 1; phs.j3 = 1;
	syl_struct ss;
	ss.phone_c = no_v; ss.word_p = no_v; ss.phr_p = no_v; ss.utt_p = no_v; ss.stress = 0;
	word_struct ws;
	ws.phone_c = no_v; ws.syl_c = no_v; ws.phr_p = no_v; ws.utt_p = no_v;
	phrase_struct ps;
	ps.phone_c = no_v; ps.syl_c = no_v; ps.word_c = no_v; ps.utt_p = no_v;
			...
			for (INTPTR i_syl = 0; i_syl < i_syl_size; i_syl++) {
				...
				for (INTPTR i_pho = 0; i_pho < i_pho_size; i_pho++) {
					phone_struct pho = utt.phr_vector[i_phr].word_vector[i_word].syl_vector[i_syl].phone_vector[i_pho];
								...
								if (lword.ai.m_szRoot == d) pho.lpos = L"0";
									else
								pho.lpos = gpos (CFSWString(lword.ai.m_cPOS));
								
								pho.pos = gpos (CFSWString(utt.phr_vector[i_phr].word_vector[i_word].ai.m_cPOS));

								if (rword.ai.m_szRoot == d) pho.rpos = L"0";
									else
								pho.rpos = gpos (CFSWString(rword.ai.m_cPOS));
